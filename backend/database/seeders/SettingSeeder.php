    ...
    public function run(): void
    {
        $settings = [
            ...
            [
                ...
                'value' => json_encode(['view_dashboard', 'manage_finance', 'view_reports', 'manage_contributions', 'manage_contribution_types', 'view_announcements', 'view_meeting_minutes', 'view_vision_missions', 'view_albums']),
                'group' => 'access_control',
                'type' => 'json',
            ...
            [
                ...
                'value' => json_encode(['view_dashboard', 'manage_members', 'manage_events', 'view_contributions', 'view_contribution_types', 'manage_announcements', 'view_announcements', 'manage_meeting_minutes', 'view_vision_missions', 'manage_organization_structures', 'manage_albums']),
                'group' => 'access_control',
                'type' => 'json',
