    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-3">
                <Link :href="route('vision-missions.show', visionMission.id)" class="shrink-0 p-1.5 rounded-lg text-muted-foreground hover:text-foreground hover:bg-muted transition-colors">
                    <ArrowLeft class="w-5 h-5" />
                </Link>
                <h2 class="text-lg font-semibold leading-tight text-foreground">Edit Visi & Misi</h2>
            </div>
        </template>
                    ...
                    <form @submit.prevent="submit" class="bg-card border rounded-xl overflow-hidden">
                        ...
                        <div class="flex items-center justify-end gap-3 px-4 sm:px-6 py-4 border-t bg-muted/30">
                            <Button variant="outline" as-child>
                                <Link :href="route('vision-missions.show', visionMission.id)">Batal</Link>
                            </Button>
