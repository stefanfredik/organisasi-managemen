...
import {
    Shield, ShieldCheck, Users, Loader2, Check,
...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between gap-3">
                <div class="flex items-center gap-2.5">
                    ...
                    <h2 class="text-lg font-semibold leading-tight text-foreground">Manajemen Role</h2>
                </div>
        ...
        <div class="py-3 sm:py-6">
            <div class="max-w-5xl mx-auto px-3 sm:px-6 lg:px-8 space-y-3 sm:space-y-4">
                ...
                <div class="bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-xl p-3 sm:p-4 flex items-center gap-3">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-xs sm:text-sm font-semibold text-purple-700 dark:text-purple-300">Admin</p>
                        <p class="text-[10px] sm:text-xs text-purple-600 dark:text-purple-400">Memiliki akses penuh ke seluruh fitur. {{ userCounts?.admin || 0 }} user.</p>
                    </div>
                </div>
