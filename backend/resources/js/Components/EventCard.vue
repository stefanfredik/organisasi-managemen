...
<template>
    <div class="flex flex-col rounded-3xl shadow-sm border border overflow-hidden hover:shadow-2xl transition-all duration-500 group bg-card h-full">
        <div class="shrink-0 relative aspect-[16/10]">
            ...
            <div class="absolute bottom-4 left-6">
                <span class="px-3 py-1 bg-card/20 backdrop-blur-md text-white border border-white/30 rounded-lg text-[10px] font-black uppercase tracking-widest shadow-sm">
        ...
        <div class="flex-1 p-8 flex flex-col">
            <div class="flex-1">
                <Link :href="route('public.events.show', event.slug)" class="block group/link">
                    <h3 class="text-2xl font-black text-foreground line-clamp-2 group-hover/link:text-primary transition-colors mb-3 uppercase tracking-tight">
                        {{ event.name }}
                    </h3>
            ...
            <div class="pt-6 border-t border flex items-center justify-between text-[11px] font-bold text-muted-foreground uppercase tracking-widest">
