...
<template>
    <div class="flex flex-col rounded-3xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-500 group bg-white h-full">
